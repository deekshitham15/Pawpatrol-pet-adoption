  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
        <div class="col-lg-8" style="text-align: center;">
          <h1>Welcome to <span>PawPatrol</span></h1>
          <h2>Where Every Paw Finds Its Perfect Home!</h2>
        </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="about-img">
              <img src="assets/img/shelter.jpg" alt="PawPatrol Shelter">
            </div>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>PawPatrol Animal Shelter</h3>
            <p class="fst-italic">
              HP (PawPatrol) is a non-profit animal shelter that helps the adoption of animals
            </p>
            <ul>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  I had a wonderful time working with PawPatrol. The animals in the shelters were cared for with care. All of the staff are passionate about helping animals.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  I adopted all of my beloved corgis from PawPatrol. PawPatrol was a delight to work with and I hope others who are interested in having pets will adopt instead of shop.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  I do my best to ensure all of the animals in my practice are comfortable, happy and safe. PawPatrol does their part to make all their animals feel that way too.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <img src="assets/img/staff/president.jpeg" class="img-fluid" alt="president of PawPatrol">
...
<footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>PawPatrol</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/PawPatrol-restaurant-template/ -->
