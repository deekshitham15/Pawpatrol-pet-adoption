    ...
    <div class="container" style="min-height:90vh">
      ...
      <form action="submitFeedback.php" method="POST">
        <div class="container">
          ...
          <div class="row mb-3">
          <label class="form-label" for="comments">Comments:</label><br>
          <textarea class="form-control" type="text" id="comments" name="comments" rows="4"></textarea>

          </div>
          <div class="row mb-3">
          <label class="form-label" for="rating">Rating (1-5):</label><br>
          <input class="form-control" type="number" id="rating" name="rating" min="1" max="5" step="1">

          </div>

          <div class="row mb-3">
            <input class="btn btn-mb btn-primary" type="submit" value="Submit Feedback">
          </div>
        </div>
      </form>
      </div>
