    ...
    <div class="container" data-aos="fade-up">
        ...
        <?php 
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='editAnimalProfile.php?animalID=" . $row["animalID"] . "'>Edit This Profile</a></span>"; 
                echo "<br><a href='deleteAnimalProfile.php?animalID=" . $row["animalID"] . "'>Delete This Profile</a></span>";
