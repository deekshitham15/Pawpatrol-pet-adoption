...
<head>
  ...
  <title>PawPatrol - Adoption Listing</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Adoption</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="displayFeedback.php">Recieved Feedback</a></li>
              <li><a href="viewQueries.php">Recieved Queries</a></li>
            </ul>
...
<div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <?php
          ...
          $sql = "SELECT animalName, age, gender,breed, imgType, animalType, animalID FROM animal";
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo "<a href='animalProfile.php?animalID=" . $row["animalID"] . "'>". $row["animalName"] . "</a>";
            echo "</div>";
            echo "<div class='menu-ingredients'> Age : " . $row["age"];
            echo "</div>";
            echo "<div class='menu-ingredients'> Breed : " . $row["breed"] ;
            echo "</div>";
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="displayFeedback.php">Recieved Feedback</a></li>
            </ul>
          </div>
